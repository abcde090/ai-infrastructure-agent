...
1. **Go Infrastructure Agent** - Backend infrastructure management tool (root directory)
2. **Aussie Birds Web App** - Interactive Australian native bird explorer (`birds-app/`)
